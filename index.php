                      ...
                      <tbody>
                        <tr>
                          <td style="min-width: 200px">
                            ...
                            <h2>
                              <a href="profile.html"
                                >Bernardo Galaviz <span>New York, USA</span></a
                              >
                            </h2>
                          </td>
                          <td>
            ...
            <div class="col-12 col-md-6 col-lg-8 col-xl-8">
              <div class="card">
                <div class="card-header">
                  ...
                  <a href="patients.html" class="btn btn-primary float-right"
                    >View all</a
                  >
                </div>
                    ...
                    <table class="table mb-0 new-patient-table">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <button
                              class="btn btn-primary btn-primary-two float-right"
                            >
                              Cancer
                            </button>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <button
                              class="btn btn-primary btn-primary-three float-right"
                            >
                              Eye
                            </button>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <button
                              class="btn btn-primary btn-primary-four float-right"
                            >
                              Fever
                            </button>
                          </td>
